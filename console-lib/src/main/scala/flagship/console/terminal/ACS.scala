...
object ACS {
  ...
  val DOUBLE_LINE_HORIZONTAL: Char = 0x2550
  val SINGLE_LINE_VERTICAL: Char = VLINE
  val DOUBLE_LINE_VERTICAL: Char = 0x2551
  val SINGLE_LINE_UP_LEFT_CORNER: Char = ULCORNER
  val DOUBLE_LINE_UP_LEFT_CORNER: Char = 0x2554
  val SINGLE_LINE_UP_RIGHT_CORNER: Char = URCORNER
  val DOUBLE_LINE_UP_RIGHT_CORNER: Char = 0x2557
  val SINGLE_LINE_LOW_LEFT_CORNER: Char = LLCORNER
  val DOUBLE_LINE_LOW_LEFT_CORNER: Char = 0x255A
  val SINGLE_LINE_LOW_RIGHT_CORNER: Char = LRCORNER
  val DOUBLE_LINE_LOW_RIGHT_CORNER: Char = 0x255D
  ...
  val SINGLE_LINE_T_DOUBLE_UP: Char = 0x256B
